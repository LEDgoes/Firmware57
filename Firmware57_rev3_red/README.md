...
Using an Arduino:
> path\to\avrdude –C path\to\avrdude.conf -v -v –p atmega168 –c arduino –P com_port -b 19200 -D -U flash:w:path/to/firmware.cpp.hex:i
...
Using a Pololu:
> path\to\avrdude –C path\to\avrdude.conf -v -v -p atmega168 -c stk500v2 -P com_port -e -U lock:w:0x3F:m -U efuse:w:0x00:m -U hfuse:w:0xdd:m -U lfuse:w:0xff:m
> path\to\avrdude –C path\to\avrdude.conf -v -v -p atmega168 -c stk500v2 -P com_port -D -Uflash:w:path\to\firmware.hex:i -Ulock:w:0x0F:m
